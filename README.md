...
Acceder a internet y navegador para obtener la URL del repositorio.
...
Elige una carpeta para clonar el proyecto: cd Documentos
...
Accede a la carpeta del proyecto: cd Ingeweb
...
Abre el programa Git Bash (viene con Git).
...
Accede al proyecto: cd Ingeweb

Abre index.html con doble clic o usa Visual Studio Code: code .
...
Historia de la ingeniería web (en index.html) ¿Qué es la ingeniería web? ( ingenieriaweb.html) Arquitectura cliente-servidor ( clienteservidor.html) Semántica y accesibilidad en HTML5 ( html5.html)
